package de.jonathan57157.food_mod_2.screen.custom;
...
public class IceCreamMakerScreen extends HandledScreen<IceCreamMakerScreenHandler> {
    private static final Identifier GUI_TEXTURE =
            Identifier.of(FoodMod2.MOD_ID, "textures/gui/ice_cream_maker/ice_cream_maker_gui.png");
    private static final Identifier ARROW_TEXTURE =
            Identifier.of(FoodMod2.MOD_ID, "textures/gui/arrow_progress.png");
    ...
    private void renderProgressArrow(DrawContext context, int x, int y) {
        if(handler.isCrafting()) {
            context.drawTexture(RenderLayer::getGuiTextured, ARROW_TEXTURE, x + 89, y + 34, 0, 0,
