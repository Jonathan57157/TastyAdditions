...
public class ModFoodComponents {
    ...
    public static final FoodComponent ICE_CREAM_WAFER = new FoodComponent.Builder().nutrition(1).saturationModifier(0.3f).build();
    ...
    public static final FoodComponent BLUEBERRIES = new FoodComponent.Builder().nutrition(2).saturationModifier(0.15f).build();
    public static final FoodComponent STRAWBERRY = new FoodComponent.Builder().nutrition(2).saturationModifier(0.15f).build();
    public static final FoodComponent HALF_TOMATO = new FoodComponent.Builder().nutrition(1).saturationModifier(0.1f).build();
}
